...
namespace Drive.Sample
{
    ...
    class Program
    {
        ...
        private const string UploadFileName = @"FILE_TO_UPLOAD.txt";
        ...
        private async Task Run()
        {
            ...
            var service = new DriveService(new BaseClientService.Initializer()
            {
                ...
                ApplicationName = "Drive.EmptyTrash",
            });

            await DeleteTrashFile(service);
        ...
        private async Task DeleteTrashFile(DriveService service)
        {
            Console.WriteLine("Deleting all file in Trash");
            await service.Files.EmptyTrash().ExecuteAsync();
            Console.WriteLine("File was deleted successfully");
        }
